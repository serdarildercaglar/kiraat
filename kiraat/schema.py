...
COLUMNS: tuple[Column, ...] = (
    ...
    Column("music_to_speech_db", "float", "music",
           "Kaynak ayrıştırmasından (HDemucs) gelen fiziksel ölçü: eşlik (davul+bas+diğer) enerjisinin vokal enerjisine oranı. Ayrıştırıcı koşmadıysa taban değer −80. `background_music` işareti bu sütundan konfigdeki eşikle türetilir.",
           unit="dB"),
    Column("music_db_separated", "bool", "music",
           "Ayrıştırıcı bu klipte gerçekten koştu mu. Hayırsa `music_to_speech_db` ölçüm değil taban değerdir (AudioSet skoru eleme eşiğinin altındaydı)."),
