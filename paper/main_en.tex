...
3,105.7 hours of Turkish read speech, segmented from 2,699 audiobook and
...
speech at 24\,kHz from 2,699 recordings on 27 channels, with 90 clustered
...
Section~\ref{sec:integrity} shows that 92.3\% of all mid-sentence starts in
...
outside the policy & 292,910 & 530.5 & 27,460 (9.39\%) & 32,916 (11.25\%) \\
\bottomrule
\end{tabular}
...
Of the 27,483 clips that begin mid-sentence, 92.3\% carry \col{forced\_split}
or \col{gap\_split}; among the 1,558,854 clips that carry no flag at all, 23
begin mid-sentence, a rate of 15 per million. The corpus does contain
...
hour target and the clips beyond that target are left unused rather than moved
into training.
...
\bottomrule
\end{tabular}
\caption{Evaluation split over the recommended subset.}
\label{tab:splits}
\end{table}
